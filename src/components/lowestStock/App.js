    ...
    useEffect(() => {
        async function getData() {
            try {
                ...
                const sort = response.data.data.sort((a, b) => a.stock - b.stock)
            ...
            <Row className="p-3 rounded align-items-center mb-4" style={{backgroundColor: '#D4F1F4'}}>
                ...
                <Col className="d-flex justify-content-end">
                    <ToggleButtonGroup type="radio" name="viewOptions" defaultValue={0} value={isListView ? 1 : 0} onChange={handleToggleChange}>
                        <ToggleButton id="lowest-check-1" value={0}>Box View</ToggleButton>
                        <ToggleButton id="lowest-check-2" value={1}>List View</ToggleButton>
                    </ToggleButtonGroup>
                </Col>
            </Row>
